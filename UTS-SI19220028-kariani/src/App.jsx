...
function App() {
  ...
  return (
    <>
      <Navbar />
      <Hero title="selamat datang dicoding." desc="Lorem ipsum dolor sit amet consectetur, adipisicing elit. Neque recusandae et id adipisci. Dicta dolore officiis neque
